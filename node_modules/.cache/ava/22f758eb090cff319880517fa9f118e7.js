...
(0, _ava2.default)('test checkout false scan', function (t) {
  t.is((0, _checkout.scan)('abc'), false);
});
(0, _ava2.default)('test checkout true scan', function (t) {
  t.is((0, _checkout.scan)('ipd'), true);
});
// test the total
(0, _ava2.default)('test checkout scan is 549.99', function (t) {
  return (0, _checkout.total)().then(function (result) {
    var _rec = new _powerAssertRecorder();

    t.log(result);
    t.true(_rec._expr(_rec._capt(_rec._capt(result, 'arguments/0/left') === 549.99, 'arguments/0'), {
      content: 't.true(result === 549.99)',
      filepath: 'tests/checkout.test.js',
      line: 14,
      ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"BinaryExpression","operator":"===","left":{"type":"Identifier","name":"result","range":[7,13]},"right":{"type":"NumericLiteral","value":549.99,"range":[18,24]},"range":[7,24]}],"range":[0,25]}',
      tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"result","range":[7,13]},{"type":{"label":"==/!="},"value":"===","range":[14,17]},{"type":{"label":"num"},"value":549.99,"range":[18,24]},{"type":{"label":")"},"range":[24,25]}]',
...
(0, _ava2.default)('test checkout scan is 549.99', function (t) {
  return (0, _checkout.total)().then(function (result) {
    ...
    t.false(_rec2._expr(_rec2._capt(_rec2._capt(result, 'arguments/0/left') === 0, 'arguments/0'), {
      content: 't.false(result === 0)',
      filepath: 'tests/checkout.test.js',
      line: 19,
      ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"false","range":[2,7]},"computed":false,"range":[0,7]},"arguments":[{"type":"BinaryExpression","operator":"===","left":{"type":"Identifier","name":"result","range":[8,14]},"right":{"type":"NumericLiteral","value":0,"range":[19,20]},"range":[8,20]}],"range":[0,21]}',
      tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"false"},"value":"false","range":[2,7]},{"type":{"label":"("},"range":[7,8]},{"type":{"label":"name"},"value":"result","range":[8,14]},{"type":{"label":"==/!="},"value":"===","range":[15,18]},{"type":{"label":"num"},"value":0,"range":[19,20]},{"type":{"label":")"},"range":[20,21]}]',
      visitorKeys: _powerAssertVisitorKeys
    }));
  });
});
//# sourceMappingURL=../node_modules/.cache/ava/22f758eb090cff319880517fa9f118e7.js.map
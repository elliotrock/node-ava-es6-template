...
// test the total
(0, _ava2.default)('test checkout scan is 0', function (t) {
  return (0, _checkout.total)().then(function (result) {
    var _rec = new _powerAssertRecorder();

    t.log(result);
    t.true(_rec._expr(_rec._capt(_rec._capt(result, 'arguments/0/left') === 0, 'arguments/0'), {
      content: 't.true(result === 0)',
      filepath: 'tests/checkout.test.js',
      line: 14,
      ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"BinaryExpression","operator":"===","left":{"type":"Identifier","name":"result","range":[7,13]},"right":{"type":"NumericLiteral","value":0,"range":[18,19]},"range":[7,19]}],"range":[0,20]}',
      tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"result","range":[7,13]},{"type":{"label":"==/!="},"value":"===","range":[14,17]},{"type":{"label":"num"},"value":0,"range":[18,19]},{"type":{"label":")"},"range":[19,20]}]',
      visitorKeys: _powerAssertVisitorKeys
    }));
  });
});
//# sourceMappingURL=../node_modules/.cache/ava/84552378482e84eacee27f86a85a2b07.js.map
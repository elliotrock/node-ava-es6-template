...
_ava2.default.todo('uncomment');
(0, _ava2.default)('test checkout false scan', function (t) {
  t.is((0, _checkout.scan)('abc'), false);
});
// first test example
(0, _ava2.default)('test checkout scan atv', function (t) {
  t.is((0, _checkout.scan)('atv'), true);
});
(0, _ava2.default)('test checkout scan ipd', function (t) {
...
(0, _ava2.default)('test checkout scan is ', function (t) {
  return (0, _checkout.total)().then(function (result) {
    ...
    t.log(result);
    t.true(_rec._expr(_rec._capt(_rec._capt(result, 'arguments/0/left') === _rec._capt(_rec._capt(109.50 * 2, 'arguments/0/right/left') + _rec._capt(499.99 * 5, 'arguments/0/right/right'), 'arguments/0/right'), 'arguments/0'), {
...
//# sourceMappingURL=../node_modules/.cache/ava/b465a5490cfbd2f097655aac95731bb9.js.map
...
(0, _ava2.default)('test pricingRules 3x ipd', function (t) {
  ...
  var total = (0, _pricingRules.pricingRules)(testBasket);
  t.log(total);
  t.true(_rec2._expr(_rec2._capt(_rec2._capt(total, 'arguments/0/left') === _rec2._capt(449.99 * 3, 'arguments/0/right'), 'arguments/0'), {
    content: 't.true(total === 449.99 * 3)',
    filepath: 'tests/pricing-rules.test.js',
    line: 17,
...
//# sourceMappingURL=../node_modules/.cache/ava/f4eefb36d44f97dee3acbc1e96b1771f.js.map